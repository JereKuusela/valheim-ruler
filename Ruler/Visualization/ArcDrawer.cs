...
public partial class Draw {
  ...
  private static Vector3 GetArcSegmentX(float angle, float radius) =>
   new(0f, Mathf.Sin(Mathf.Deg2Rad * angle) * radius, Mathf.Cos(Mathf.Deg2Rad * angle) * radius);
  ...
  private static Vector3 GetArcSegmentY(float angle, float radius) =>
   new(Mathf.Sin(Mathf.Deg2Rad * angle) * radius, 0f, Mathf.Cos(Mathf.Deg2Rad * angle) * radius);
  ...
  private static Vector3 GetArcSegmentZ(float angle, float radius) =>
   new(Mathf.Sin(Mathf.Deg2Rad * angle) * radius, Mathf.Cos(Mathf.Deg2Rad * angle) * radius, 0f);
